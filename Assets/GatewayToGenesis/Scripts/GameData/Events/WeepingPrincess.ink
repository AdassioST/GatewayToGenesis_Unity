# Weeping Princess Event
# A mystical encounter with a sorrowful spirit who seeks redemption

# screen_flow: splash,verse,chorus,outro
# event_type: Mystical
# priority: 8
# event_color: mystical
# splash_art: weeping_princess_splash
# background: mystical_forest

=== weeping_princess_start ===
# conditions: score:quest_progress >= 1
# consequences: score:quest_progress +1; score:weeping_princess_encounter +1
...
* [Follow the sound] -> weeping_princess_verse_1
...
She is the Weeping Princess, a spirit bound to this place by sorrow and regret. Her tears fall like diamonds, each one carrying the weight of centuries of grief.

* [Approach her] -> weeping_princess_chorus_1
...
=== weeping_princess_challenge_1 ===
The path of Idealism glows with golden light, but shadows dance at its edges. Your heart guides you, but will your courage be enough to face the darkness that lies ahead?

* [Face the challenge] -> weeping_princess_resolution_1

=== weeping_princess_resolution_1 ===
* [Continue] -> END

=== weeping_princess_challenge_2 ===
The path of Pragmatism shimmers with harmonious light, but maintaining balance is never easy. The forces around you pull in different directions, testing your ability to find equilibrium.

* [Face the challenge] -> weeping_princess_resolution_2

=== weeping_princess_resolution_2 ===
* [Continue] -> END
...
* [Embrace the dream realm] -> weeping_princess_outro
...
* [Learn from the experience] -> weeping_princess_outro
...
* [Apply your newfound wisdom] -> weeping_princess_outro
...
* [Embrace the harmony] -> weeping_princess_outro
...
* [Learn from the struggle] -> weeping_princess_outro
